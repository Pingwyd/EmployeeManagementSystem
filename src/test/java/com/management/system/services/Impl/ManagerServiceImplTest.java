...
class ManagerServiceImplTest {
    ...
    void getMyDetails() {
        ...
        EmployeeResponseDTO result = managerService.getMyDetails(email);
    ...
    void getMyDetailsTest_EmployeeNotFound() {
        ...
        log.error("Error: ", assertThrows(NotFoundException.class, () -> managerService.getMyDetails(email)));
    ...
    @Test
    void getEmployeesInMyDepartment_EmployeeNotFound() {
        when(employeeRepository.findByEmail(email)).thenReturn(Optional.empty());

        log.error("Error: ", assertThrows(NotFoundException.class, () -> managerService.getEmployeesInMyDepartment(email)));
    }
}